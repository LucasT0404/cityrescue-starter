...
public interface CityRescue {
    ...
    int addUnit(int stationId, UnitType type)
    ...
    int reportIncident(IncidentType type, int severity, int x, int y)
    ...
    void escalateIncident(int incidentId, int newSeverity)
